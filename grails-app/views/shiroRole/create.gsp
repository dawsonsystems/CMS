...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'shiroRole.label', default: 'cms.ShiroRole')}"/>
        ...
        <div class="dialog">
            <table>
                ...
                <tr class="prop">
                    ...
                    <td valign="top"
                        class="value ${hasErrors(bean: shiroRoleInstance, field: 'permissions', 'errors')}">
                        <shiroui:permissionSelect name="permissions" size="10"
                                                  value="${shiroRoleInstance?.permissions}"/>
                    </td>
                </tr>

                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="description"><g:message code="shiroRole.description.label"
                                                            default="Description"/></label>
                    </td>
                    <td valign="top"
                        class="value ${hasErrors(bean: shiroRoleInstance, field: 'description', 'errors')}">
