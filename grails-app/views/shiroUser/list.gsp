        ...
        <table>
            ...
            <tr>
                ...
                <g:sortableColumn property="firstName"
                                  title="${message(code: 'shiroUser.firstName.label', default: 'First Name')}"/>

                <g:sortableColumn property="lastName"
                                  title="${message(code: 'shiroUser.lastName.label', default: 'Last Name')}"/>
            ...
            <g:each in="${shiroUserInstanceList}" status="i" var="shiroUserInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    <td><g:link action="show"
                                id="${shiroUserInstance.id}">${fieldValue(bean: shiroUserInstance, field: "id")}</g:link></td>
                    ...
                    <td><a href="mailto:${fieldValue(bean: shiroUserInstance, field: "email")}">${fieldValue(bean: shiroUserInstance, field: "email")}</a>
                    </td>
